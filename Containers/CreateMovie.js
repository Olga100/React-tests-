...
export class CreateMovieForm extends React.Component {
...
/*
 CreateMovie это обёртка над CreateMovieForm + аddMovie.Создаётся connect`om. Для работы коннекта нужен провайдер(указан там где главный рендер)
 mapDispathcToProps описывает что нужно довабисть в пропс созданной обёртки(функции)

 http://www.theamazingpics.com/wp-content/uploads/2014/05/Amazing-Picture-of-A-Japanese-Garden-in-Portland-USA.jpg
 */