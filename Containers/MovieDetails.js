...
/*
 const mapStateToProps = (state, ownProps) => ({
 movies: state.movies,
 currentMovie: state.currentMovie,    //всё что до двоеточия(мувис, каррентмувис сетАлмин - падают в пропсы, т.е. обращаемся мы к ним через this.props.
 ...
 const Movies = connect(mapStateToProps, mapDispatchToProps)(MoviesIndexView);
